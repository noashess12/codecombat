...
#    guide: "الارشاد"
#    restart: "اعادة تشغيل المرحلة"
#    goals: "الأهداف"
#    goal: "هدف"
#    running: "جاري التحميل ..."
#    success: "نجاح!"
#    incomplete: "غير مكتمل"
#    timed_out: "انتهاء الوقت"
#    failing: "الفشل"
#    action_timeline: "وقت الفعل"
#    click_to_select: "اضغط على وحدة للأختيار."
#    control_bar_multiplayer: "متعدد اللاعبين"
#    control_bar_join_game: "الانضمام للعبة"
#    reload: "اعادة التحميل"
#    reload_title: "اعادة تحميل كل الرموز?"
#    reload_really: "هل انت متأكد انك تريد اعادة المستوى الى البداية?"
#    reload_confirm: "اعادة تحميل الكل"
#    victory: "النصر"
#    victory_title_prefix: ""
#    victory_title_suffix: " اكتمال"
#    victory_sign_up: "يرجى التسجيل لحفظ تقدمك !"
#    victory_sign_up_poke: "هل تريد حفظ رمزك? "اصنع حساب مجاني
#    victory_rate_the_level: "تقييم المرحلة: " # Only in old-style levels.
#    victory_return_to_ladder: "العودة الى السلم"
#    victory_play_continue: "الأستمرار"
#    victory_saving_progress: "يتم حفظ التقدم"
#    victory_go_home: "الذهاب للصفحة الرئيسية" # Only in old-style levels.
#    victory_review: "أخبرنا بالمزيد!" # Only in old-style levels.
#    victory_hour_of_code_done: "هل انتهيت?"
#    victory_hour_of_code_done_yes: "نعم, I'm finished with my Hour of Code™!"
#    victory_experience_gained: "خبرة اكتسبت"
#    victory_gems_gained: "جواهر اكتسبت"
#    victory_become_a_viking: "أصبح فايكنغ"
#    guide_title: "مرشد"
